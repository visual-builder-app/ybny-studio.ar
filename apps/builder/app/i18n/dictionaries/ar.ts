...
export const ar: Dictionary = {
  stylePanel: {
    ...
    transitions: {
      ...
      code: "الكود",
      codeHint: "الصق كود CSS لانتقال كامل أو جزء من انتقال، على سبيل المثال:",
      property: "الخاصية",
      duration: "المدة",
      delay: "التأخير",
      timingFunction: "التخفيف",
    },
    transforms: {
      label: "التحويلات",
      inlineWarning:
    ...
    propertyLabel: {
      local: "محلي",
      baseBreakpoint: "الأساس",
      valueSource: "مصدر القيمة",
      deleteProperty: "حذف الخاصية",
      resetValue: "إعادة تعيين القيمة",
      advancedValueWarning: "تم تعريف هذه القيمة في القسم المتقدم.",
    },
    styleSourceStates: {
      hover: "مرور المؤشر",
      focus: "التركيز",
      "focus-visible": "التركيز المرئي",
      "focus-within": "التركيز الداخلي",
      active: "النشاط",
      visited: "الزيارة",
      disabled: "التعطيل",
      checked: "التحديد",
      ...
      "nth-child": "الابن بترتيب",
      empty: "فارغ",
      target: "الهدف",
      "::before": "قبل العنصر",
      "::after": "بعد العنصر",
      "::placeholder": "النص النائب",
      "::selection": "التحديد النصي",
