      ...
      {allowDynamicData === false && (
        <PanelBanner>
          ...
          <Text variant="regularBold">
            قم بالترقية لأجل CMS على النطاقات المخصصة
          </Text>
          <Text>
            ادمج المحتوى من أدوات أخرى لإنشاء المدونات والأدلة وأي محتوى منظم آخر.
            يمكنك معاينة CMS على بيئة التجربة دون ترقية.
          </Text>
        </PanelBanner>
      )}
    </Box>
